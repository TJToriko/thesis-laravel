    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="card-title">Edit Payment Option</div>
            </div>
            <form action="{{ route('apsetting.update', $paymentsetting->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="row">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select2-ltype form-control" name="lot_type_id" id="ltype" required>
                                            ...
                                            @foreach($lottype as $ltype)
                                                <option value="{{ $ltype->id }}" {{ $paymentsetting->lot_type_id == $ltype->id ? 'selected' : '' }}>{{ ucwords(strtolower($ltype->lot_type_name)) }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select2-lclass form-control" name="lot_class_id" id="lclass">
                                            ...
                                            @foreach($lotclass as $lclass)
                                                <option value="{{ $lclass->id }}" {{ $paymentsetting->lot_class_id == $lclass->id ? 'selected' : '' }}>{{ ucwords(strtolower($lclass->lot_class_name)) }}</option>
                                            @endforeach
                                        </select>
                                        @error('lot_class_id')
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="payment_name" class="form-control" id="pname" placeholder="Enter Payment Name" required value="{{ $paymentsetting->payment_name }}">
                                        @error('payment_name')
                                            <small id="emailHelp2" class="form-text text-muted text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                            ...
                            <div class="col-md-12">
                                <ul class="nav nav-pills nav-secondary nav-pills-no-bd" id="pills-tab-without-border" role="tablist">
                                    <li class="nav-item" id="cashlist">
                                        <label for="cashRadio" class="nav-link {{ $paymentsetting->payment_type == 'Cash' ? 'active' : '' }}" id="pills-home-tab-nobd" data-toggle="pill" href="#pills-home-nobd" role="tab" aria-controls="pills-home-nobd" aria-selected="{{ $paymentsetting->payment_type == 'Cash' ? 'true' : 'false' }}">Cash</label>
                                        <input class="form-check-input" type="radio" hidden name="payment_type" id="cashRadio" value="Cash" {{ $paymentsetting->payment_type == 'Cash' ? 'checked' : '' }}>
                                    </li>
                                    <li class="nav-item" id="installmentlist">
                                        <label for="installmentRadio" class="nav-link {{ $paymentsetting->payment_type == 'Installment' ? 'active' : '' }}" id="pills-profile-tab-nobd" data-toggle="pill" href="#pills-profile-nobd" role="tab" aria-controls="pills-profile-nobd" aria-selected="{{ $paymentsetting->payment_type == 'Installment' ? 'true' : 'false' }}">Installment</label>
                                        <input class="form-check-input" type="radio" hidden name="payment_type" id="installmentRadio" value="Installment" {{ $paymentsetting->payment_type == 'Installment' ? 'checked' : '' }}>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content mt-2 mb-3" id="pills-without-border-tabContent">
                                <div class="tab-pane fade {{ $paymentsetting->payment_type == 'Cash' ? 'active show' : '' }}" id="pills-home-nobd" role="tabpanel" aria-labelledby="pills-home-tab-nobd">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="fullprice">Full Price</label>
                                            <input type="text" name="cash_full_price" class="form-control" id="fullprice" placeholder="Enter Full Price" value="{{ $paymentsetting->cash_full_price }}">
                                ...
                                <div class="tab-pane fade {{ $paymentsetting->payment_type == 'Installment' ? 'active show' : '' }}" id="pills-profile-nobd" role="tabpanel" aria-labelledby="pills-profile-tab-nobd">
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label for="fprice">Full Price</label>
                                                <input type="text" class="form-control" id="fprice" placeholder="Enter Full Price" name="installment_full_price" value="{{ $paymentsetting->installment_full_price }}">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="noyear" placeholder="Enter Number Of Years" min="1" value="{{ $paymentsetting->no_year }}" name="no_year">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="mprice">Monthly Price</label>
                                                <input type="text" class="form-control" id="mprice" placeholder="Enter Monthly Price" name="installment_monthly_price" value="{{ $paymentsetting->installment_monthly_price }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" type="checkbox" value="yes" {{ $paymentsetting->with_rebate == 'yes' ? 'checked' : '' }} name="with_rebate" id="with_rebate">
                                                ...
                                                <div class="col-md-12" style="margin-top: -19px;">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="rebate_price" placeholder="Enter Rebate Price" name="rebate_price" value="{{ $paymentsetting->rebate_price }}">
                                                        @error('rebate_price')
                                                            <small id="emailHelp2" class="form-text text-muted text-danger">{{ $message }}</small>
                                                        @enderror
                                                    </div>
                                        ...
                                        <div class="col-md-6" >
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="min_amount" placeholder="Enter Minimum Price Amount" name="min_amount" value="{{ $paymentsetting->min_amount }}">
                                                @error('min_amount')
                                                    <small id="emailHelp2" class="form-text text-muted text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
...
<script>
    $(document).ready(function() {
        // Hide the rebate price input by default
        $('#rebate_price').hide();

        // Check the initial state of the 'with_rebate' checkbox
        if ($('#with_rebate').prop('checked')) {
