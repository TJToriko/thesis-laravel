                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="birthdate" name="date_of_birth" required value="{{ old('date_of_birth') }}">
                                @error('date_of_birth')
                                    <small id="emailHelp2" class="form-text text-muted text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                    ...
                    <div class="row row-beneficiary">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="bbirthdate" name="benificiary_date_of_birth" required value="{{ old('benificiary_date_of_birth') }}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="monthlydue">Next Month Due</label>
