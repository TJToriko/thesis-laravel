                            ...
                            "features": [
                                @foreach($lotstatusget as $lot)
                                {
                                    ...
                                    "properties": {
                                        ...
                                        @endif
                                        @if($lot->customer_id && !empty($lot->customer->first_name)),
                                        "lotCustomer": "{{ $lot->customer->first_name }} {{ $lot->customer->middle_name }} {{ $lot->customer->last_name }} {{ $lot->customer->suffix }}"
                                        @endif
                                    },
                                    "geometry": {
                                        "coordinates": [[
                    ...
                    <script>
                        ...
                        var geojsonLayer3 = L.geoJson(rectangles, {
                                ...
                                onEachFeature: function (feature, layer) {
                                    ...
                                    var lotCustomer = feature.properties.lotCustomer;
                                    ...
                                    // Check if Lot customer is not empty before adding it to the popup
                                    if (lotCustomer && lotCustomer.trim() !== '') {
                                        popupContent += '<br><b>Lot Owner:</b> <span>' + lotCustomer + '</span>';
                                    }
                                    ...
                                    if (lotStatus === 'Available') {
                                        popupContent += '<br><a class="btn" href="{{ url('lot/session-lot-store/map/') }}/' + lotID + '">Select Lot</a>';
