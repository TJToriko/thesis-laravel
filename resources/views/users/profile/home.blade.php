                          ...
                          <div class="row">
                            <div class="col-lg-4">
                                <a href=""> 
                                  <div class="card" >
                                    <div class="card-body">
                                      <h5 class="card-title text-success text-center">Total Lots</h5>
                                      <h6 class="card-subtitle mb-2 text-muted text-center">{{ $totallots }}</h6>
                                    </div>
                                  </div>
                                </a>
                            </div>
                            <div class="col-lg-4">
                                <a href=""> 
                                  <div class="card" >
                                    <div class="card-body">
                                      <h5 class="card-title text-success text-center">Reserved Lots</h5>
                                      <h6 class="card-subtitle mb-2 text-muted text-center">{{ $reservedlots }}</h6>
                                    </div>
                                  </div>
                                </a>
                            </div>
                            <div class="col-lg-4">
                                <a href=""> 
                                  <div class="card" >
                                    <div class="card-body">
                                      <h5 class="card-title text-success text-center">Paid Lots</h5>
                                      <h6 class="card-subtitle mb-2 text-muted text-center">{{ $paidlots }}</h6>
                                    </div>
                                  </div>
                                </a>
                            </div>
                                  ...
                                  <tbody>
                                    ...
                                    @foreach ($userlot as $row)
                                        <tr>
                                          ...
                                          <td>{{ $row->paymentsetting->payment_name }}</td>
                                        </tr>
                                        @php
                                          $counter++
                                        @endphp
